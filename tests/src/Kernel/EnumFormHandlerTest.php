...
use Drupal\enum\Form\EnumFormHandler;
 ...
 *
 */
class EnumFormHandlerTest extends KernelTestBase {
  ...
  public function testSubmitSelectItem() {
    ...
    $handler = new EnumFormHandler($form_state);
  ...
  protected function buildEnumForm($operation, $values = []) {
    ...
    $entity = $this->container->get('entity_type.manager')->getStorage($entity_type)->create($values);
